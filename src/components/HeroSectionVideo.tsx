            ...
            <div className="relative z-10 h-full max-w-[1920px] mx-auto px-12">
                ...
                <div className="absolute top-28 left-0 right-0 flex justify-between px-12 pointer-events-none">
                    ...
                    <div className="flex items-center gap-4 bg-black/40 backdrop-blur-md rounded-full px-5 py-2 border border-white/10">
                        <div className="text-right"><p className="text-xs font-bold font-space">CPT. AHK</p><p className="text-[10px] text-white/50 uppercase">COMMAND</p></div>
                ...
                <div className="absolute bottom-12 right-12 bg-black/80 backdrop-blur-3xl border border-white/10 rounded-[2rem] p-8 w-80 shadow-2xl">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p className="text-2xl font-bold font-space">32,800 <span className="text-xs font-normal text-white/50">FT</span></p>
                        </div>
                        <div className="text-right">
                            <p className="text-[10px] font-space text-white/40 tracking-widest uppercase">Velocity</p>
                            <p className="text-2xl font-bold font-space">1.21 <span className="text-xs font-normal text-white/50">MACH</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="absolute bottom-12 left-12 max-w-5xl pointer-events-none">
                    <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8 }}>
                        <div className="relative">
                            <h1 className="text-[9rem] font-bold text-transparent bg-clip-text bg-gradient-to-b from-white via-white/80 to-white/40 leading-[0.8] tracking-tighter drop-shadow-2xl">THE<br />EXECUTIONER</h1>
                        </div>
                        <div className="mt-8 pl-6 border-l-2 border-white/40 pointer-events-auto">
                            ...
                            <div className="flex gap-4 mt-6">
                                <button onClick={() => scrollTo('overview')} className="px-8 py-3 bg-white text-black font-bold font-space text-sm tracking-widest rounded transition hover:scale-105">INITIATE</button>
                                <button onClick={() => scrollTo('specs')} className="px-8 py-3 border border-white/30 text-white font-bold font-space text-sm tracking-widest rounded backdrop-blur-md hover:bg-white/10">SPECS</button>
                            </div>
                        </div>
                    </motion.div>
                </div>
